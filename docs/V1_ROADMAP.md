...
| Tests / CI | 🟡 | Pytest suite expanding; cov floor in CI; Playwright smoke; Locust file |
| Docs | ✅ | Checklist, architecture C4, user guides, runtime doc |
...
3. [x] Trivy / pip-audit / npm audit / gitleaks in CI (soft-fail → harden)
4. [ ] Blocking CRITICAL scans on release tags
5. [ ] Grafana alert pack production-ready
...
- [ ] Runbook: deploy, rollback, rotate secrets, WhatsApp session restore
